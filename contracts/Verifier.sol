...
contract PlonkVerifier {
    ...
    uint256 constant Qmx  = 8501958062400641937199208813917127714360074012673305400972188402910725710398;
    uint256 constant Qmy  = 14387900430582693801532555118878003102230902497060083532967617082983345064111;
    uint256 constant Qlx  = 21627186710556220871980192645253717494254055412035327673470505798896237080928;
    uint256 constant Qly  = 16105122639435181733799637872791063101922236704827401352874424144028476691008;
    uint256 constant Qrx  = 8501958062400641937199208813917127714360074012673305400972188402910725710398;
    uint256 constant Qry  = 7500342441256581420713850626379271986465408660237740129721420811661881144472;
    uint256 constant Qox  = 0;
    uint256 constant Qoy  = 0;
    uint256 constant Qcx  = 0;
    uint256 constant Qcy  = 0;
    uint256 constant S1x  = 13786176222186328115566068456634104677889458462420408886022374828664001759917;
    uint256 constant S1y  = 19654786083723642995085018122579082649620551789589587034990728023144542747716;
    uint256 constant S2x  = 9397545003154700738571701861757108207406337519851330086045792558312740347271;
    uint256 constant S2y  = 15656205462331553802447552705587305223560887066164801914404819233424457422248;
    uint256 constant S3x  = 2041432415498598687907456537526890110299867423211409397047366422726345358669;
    uint256 constant S3y  = 16628800513623117692656524698439755115933044523299463828811002219719116422549;
    uint256 constant k1   = 2;
    uint256 constant k2   = 3;
    uint256 constant X2x1 = 12880303420550296219713387665420848742023859232641994996440224412462618597482;
    uint256 constant X2x2 = 18595366029689277574226605248785188883294123641898095858022150200241385327394;
    uint256 constant X2y1 = 17393519532062862799161160228012609846442389027672644979534997291319898597587;
    uint256 constant X2y2 = 3292653023504787369877974627936288442673202722139151270987648170616437153304;
    ...
    function verifyProof(uint256[24] memory proof, uint256[1] memory pubSignals) public view returns (bool) {
        assembly {
            /////////
            ...
            checkInput()
            calculateChallenges(pMem, pubSignals)
